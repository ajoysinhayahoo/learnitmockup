...
var videoUploadController 	= require.main.require("./controller/common/video_upload_controller");
...
module.exports = function (app, zcache) {
     ...
     *
     */
    app.post('/api/uploadpvtvideo/:application/:itisfor/:type', function (req, res) {
        ...
        if (req.params.application != null && req.params.application != undefined
            ...
            if (req.params.itisfor != null && req.params.itisfor != undefined
                ...
                if (req.params.type != null && req.params.type != undefined &&
                    ...
                    form.on('part', function(part) {
                        ...
                        var destinationPath = Constants.VIDEOS + "/" + application + "/" + itisfor+ "/" +type+ "/" +  security +"/"+fileName;
                        ...
                        if (part.filename) { //a file upload
                            s3.putObject({
                                ...
                                if (err) {
                                    ...
                                    videoUploadController.uploadVideoFileDetails(application, destinationPath, type, fileName, fileExt, securityFlag)
                    ...
                    var error = new ApiResponse({
                        success : false,
                        extras : JSON.parse(messages.VIDEO_UPLOAD_ERROR_TYPE)
                    })
                ...
                var error = new ApiResponse({
                    success : false,
                    extras : JSON.parse(messages.VIDEO_UPLOAD_ERROR_ITISFOR)
                })
            ...
            var error = new ApiResponse({
                success : false,
                extras : JSON.parse(messages.VIDEO_UPLOAD_ERROR_APPLICATION)
            })
     ...
     */
    app.post('/api/uploadpubvideo/:application/:itisfor/:type', function (req, res) {
