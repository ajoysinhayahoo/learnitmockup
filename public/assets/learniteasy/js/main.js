(function($) {
    ...
    $('#registration-button').on('click', function(e) {
        e.preventDefault();
        var self = $(this),
            target = self.next('#registration-form');
        if (self.hasClass('open')) {
            target.slideUp('slow');
            self.removeClass('open');
        } else {
    ...
    $('#registration-form').on('click', '.form-cancel', function(e) {
        e.preventDefault();
        var self = $(this),
            parent = self.parents('#registration-form'),
            loginButton = parent.prev('#registration-button');
        parent.slideUp('slow');
        loginButton.removeClass('open');
    });
